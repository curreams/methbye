		...
		<div class="row">
			<div id="carouselHacked" class="carousel slide carousel-fade" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					...
					<!--</div>-->
					<!--<div class="item">-->
						<!--<img src="img/home-picture3.jpg" alt="">-->
						<!--<div class="carousel-caption">-->
							<!--<h1>Meth-Bye</h1>-->
							<!--<p>highquality service for men &amp; women</p>-->
							<!--&lt;!&ndash;<button>learn more</button>&ndash;&gt;-->
						<!--</div>-->
					<!--</div>-->
					<!--<div class="item">-->
						<!--<img src="img/home-picture3.jpg" alt="">-->
	...
	<div class="container">
		<div class="row">
			...
			<div class="intro_layout">
				...
				<!--<div class="col-md-4 col-sm-6 intro_inline" id="intro_family_friend">-->
					<!--<div class="single-about-detail">-->
						...
						<!--<div class="about-details">-->
							...
							<!--&lt;!&ndash;<h3>Children’s specialist</h3>&ndash;&gt;-->
							<!--&lt;!&ndash;<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.</p>&ndash;&gt;-->
							<!--<h3>How to help your friend</h3>-->
							<!--<p>You may need more information to help your friend</p>-->
						<!--</div>-->
					<!--</div>-->
				<!--</div>-->
			</div>
...
<!--&lt;!&ndash; service section starts here &ndash;&gt;-->
<!--<section class="service text-center" id="service">-->
	<!--<div class="container">-->
		<!--<div class="row">-->
			<!--&lt;!&ndash;<h2>our services</h2>&ndash;&gt;-->
			<!--<h2>Meth-bye</h2>-->
			<!--&lt;!&ndash;<h4>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</h4>&ndash;&gt;-->
			<!--<h4>A good way to help you trace your way to quit meth</h4>-->
		...
		<!--</div>-->
	<!--</div>-->
<!--</section>&lt;!&ndash; end of service section &ndash;&gt;-->
	...
	<!--<div class="container">-->
		<!--<div class="row">-->
			<!--<div class="team-heading text-center">-->
				<!--<h2>Infromation</h2>-->
				<!--&lt;!&ndash;<h4>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled</h4>&ndash;&gt;-->
				<!--<h4>You can find some useful information about how to improve your health here</h4>-->
			<!--</div>-->
...
<!--&lt;!&ndash;<div class="api-map" id="contact">&ndash;&gt;-->
	<!--&lt;!&ndash;<div class="container-fluid">&ndash;&gt;-->
		<!--&lt;!&ndash;<div class="row">&ndash;&gt;-->
			<!--&lt;!&ndash;<div class="col-md-12 map" id="map"></div>&ndash;&gt;-->
		<!--&lt;!&ndash;</div>&ndash;&gt;-->
	<!--&lt;!&ndash;</div>&ndash;&gt;-->
<!--&lt;!&ndash;</div>&lt;!&ndash; end of map section &ndash;&gt;&ndash;&gt;-->

<!--&lt;!&ndash;our group section&ndash;&gt;-->
<!--<section class="service text-center ourGroup" id="ourGroup">-->
	<!--<div class="container">-->
		<!--<div class="row">-->
			<!--&lt;!&ndash;<h2>our services</h2>&ndash;&gt;-->
			<!--<h2>Our Group</h2>-->
			<!--<br><br>-->
			<!--&lt;!&ndash;<h4>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</h4>&ndash;&gt;-->
			<!--&lt;!&ndash;<h4>The goup members</h4>&ndash;&gt;-->
			<!--<div class="col-md-3 col-sm-6">-->

				<!--&lt;!&ndash;<div class="single-service">&ndash;&gt;-->
					<!--<img src="img/WechatIMG13.png" height="200px" width="200px"/>-->
					<!--&lt;!&ndash;<div class="single-service-img">&ndash;&gt;-->
						<!--&lt;!&ndash;<div class="service-img">&ndash;&gt;-->
							<!--&lt;!&ndash;<img class="heart img-responsive" src="img/service1.png" alt="">&ndash;&gt;-->
						<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--<h3>Yui</h3>-->
				<!--&lt;!&ndash;</div>&ndash;&gt;-->
			<!--</div>-->
			<!--<div class="col-md-3 col-sm-6">-->
				<!--<img src="img/WechatIMG14.jpeg" height="200px" width="200px"/>-->
				<!--<h3>Seb</h3>-->
			...
			<!--</div>-->
				<!--&lt;!&ndash;<div class="single-service">&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="single-service-img">&ndash;&gt;-->
						<!--&lt;!&ndash;<div class="service-img">&ndash;&gt;-->
							<!--&lt;!&ndash;<img class="brain img-responsive" src="img/service2.png" alt="">&ndash;&gt;-->
						<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;<h3>brain problem</h3>&ndash;&gt;-->
				<!--&lt;!&ndash;</div>&ndash;&gt;-->



			<!--<div class="col-md-3 col-sm-6">-->
				<!--<img src="img/WechatIMG15.jpeg" height="200px" width="200px"/>-->
				<!--<h3>Yunqi</h3>-->

				<!--&lt;!&ndash;<div class="single-service">&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="single-service-img">&ndash;&gt;-->
						<!--&lt;!&ndash;<div class="service-img">&ndash;&gt;-->
							<!--&lt;!&ndash;<img class="knee img-responsive" src="img/service3.png" alt="">&ndash;&gt;-->
						<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;<h3>knee problem</h3>&ndash;&gt;-->
				<!--&lt;!&ndash;</div>&ndash;&gt;-->


			<!--</div>-->
			<!--<div class="col-md-3 col-sm-6">-->
				<!--<img src="img/WechatIMG16.jpeg" height="200px" width="200px"/>-->
				<!--<h3>Jay</h3>-->

				<!--&lt;!&ndash;<div class="single-service">&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="single-service-img">&ndash;&gt;-->
						<!--&lt;!&ndash;<div class="service-img">&ndash;&gt;-->
							<!--&lt;!&ndash;<img class="bone img-responsive" src="img/service4.png" alt="">&ndash;&gt;-->
						<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;<h3>human bones problem</h3>&ndash;&gt;-->
				<!--&lt;!&ndash;</div>&ndash;&gt;-->
				<!--</div>-->
		<!--</div>-->
	<!--</div>-->
...
<!--<section class="contact">-->
	<!--<div class="container">-->
		...
		<!--</div>-->
	<!--</div>-->
<!--</section>&lt;!&ndash; end of contact section &ndash;&gt;-->
