                    ...
                    <div class="card-body methfont" >
                        ...
                        {{ csrf_field() }}
                            <div class="form-group {{ $errors->has('date_begin') ? 'has-error' : '' }}">
                                <label for="date_begin" class="col-md-2 control-label label-form">Initial Date</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group {{ $errors->has('date_end') ? 'has-error' : '' }}">
                                <label for="date_end" class="col-md-2 control-label label-form">Final Date</label>
                                <div class="col-md-4">
